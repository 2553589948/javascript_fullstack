...
.loader .face:nth-child(1) {
  ...
  border-color: currentColor transparent transparent currentColor; /* 继承颜色、右下透明 */
  --deg: -45deg;
...
.loader .face .cicle::before {
  ...
  border-radius: 50%;
  box-shadow: 0 0 2em, 0 0 4em, 0 0 6em, 0 0 8em, 0 0 10em, 0 0 0 0.5em,
    rgba(255, 255, 0, 0.1);
}
@keyframes animate {
  to {
    transform: rotate(1turn); /* 转一圈 */
  }
}
/* loader end */
